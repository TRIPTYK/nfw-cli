    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                useYarn = argv.yarn;
                clearConsole();
                console.log(chalk.blue('NFW'));
                // process cwd is changed in newAction to the new project folder
                return [4 /*yield*/, newAction(name, !defaultEnv, useDifferentPath, useYarn)
                        .then(function () {
            ...
            case 1:
                // process cwd is changed in newAction to the new project folder
                _a.sent();
                migrationSpinner = new Spinner("Executing migration ...");
                migrationSpinner.start();
                return [4 /*yield*/, migrateAction("init_project")
