...
module.exports = function () { return __awaiter(_this, void 0, void 0, function () {
    var sqlAdaptor, databaseName, p_tables, p_tablesIn, Bridgings, foreignConstraint, _a, tables, tablesIn, crudOptions, j, _b, columns, foreignKeys, j_1, j_2;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 5:
                _c.sent();
                return [4 /*yield*/, generateEntityFiles(tables[j][tablesIn], crudOptions, entityModelData)];
            case 6:
                _c.sent();
                _c.label = 7;
            case 7:
                j++;
                return [3 /*break*/, 3];
            case 8: return [4 /*yield*/, _BridgingTableHander(Bridgings)];
            case 9:
                _c.sent();
                return [4 /*yield*/, _RelationHandler(foreignConstraint)];
            case 10:
                _c.sent();
                return [2 /*return*/];
        }
 ...
 * @returns {Promise<void>}
 */
var _BridgingTableHander = function (Bridgings) { return __awaiter(_this, void 0, void 0, function () {
    var j, _a, m1Name, m2Name;
 ...
 * @returns {Promise<void>}
 */
var _RelationHandler = function (foreignConstraint) { return __awaiter(_this, void 0, void 0, function () {
    var j, response, _a, m1Name, m2Name;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                j = 0;
