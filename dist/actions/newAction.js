 ...
 */
module.exports = function (name, defaultEnv, pathOption, yarn) { return __awaiter(_this, void 0, void 0, function () {
    var pckManager, envVar, kickstart, setupEnv, config, envFilePath, ormConfigPath, envFileWriter, jsonFileWriter;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                pckManager = yarn ? 'yarn' : 'npm';
                if (!pathOption) return [3 /*break*/, 2];
            ...
            case 5:
                ...
                return [4 /*yield*/, exec(pckManager + " " + (yarn ? 'add' : 'install') + " bcrypt --save")
                        .then(function () { return console.log(chalk.green("Installed bcrypt successfully")); })];
            case 6:
                _a.sent();
                return [4 /*yield*/, exec(pckManager + " " + (yarn ? '' : 'install'))
                        .then(function () { return console.log(chalk.green("Installed packages successfully")); })];
            case 7:
                _a.sent();
                kickstart.stop();
 ...
 * @returns {Promise<void>}
 */
var _gitCloneAndRemove = function (name) { return __awaiter(_this, void 0, void 0, function () {
